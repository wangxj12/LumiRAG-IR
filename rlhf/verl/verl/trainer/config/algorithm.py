...
class FilterGroupsConfig(BaseConfig):
    ...
    hard_to_easy: bool = False
    easy_to_hard: bool = False
    center_to_sides: bool = False
    reorder_batch_enable: bool = False
    reorder_batch_hard_to_easy: bool = False
    reorder_batch_easy_to_hard: bool = False
