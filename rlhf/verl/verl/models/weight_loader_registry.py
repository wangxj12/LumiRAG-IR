...
def get_weight_loader(arch: str):
    ...
    _MODEL_WEIGHT_MEGATRON_LOADER_REGISTRY = {
        ...
        "YuanForCausalLM": load_state_dict_to_megatron_gptmodel,
        "YuanVLChatModel": load_state_dict_to_megatron_gptmodel,
    }
...
def get_weight_saver(arch: str):
    from verl.models.mcore.saver import (
        ...
        merge_megatron_ckpt_gptmodel_yuan,
        merge_megatron_ckpt_gptmodel_yuan_vl,
    ...
    _MODEL_WEIGHT_MEGATRON_SAVER_REGISTRY = {
        ...
        "YuanForCausalLM": merge_megatron_ckpt_gptmodel_yuan,
        "YuanVLChatModel": merge_megatron_ckpt_gptmodel_yuan_vl,
    }
