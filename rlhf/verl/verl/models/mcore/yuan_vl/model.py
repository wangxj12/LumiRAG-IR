...
# from .transformer_config import YuanVLTransformerConfig
from megatron.core.packed_seq_params import PackedSeqParams
from megatron.core.transformer import MegatronModule
from megatron.core.transformer.spec_utils import ModuleSpec
from megatron.core.transformer.transformer_config import TransformerConfig

from verl.models.mcore.yuan.attention import YuanSelfAttention
from .vision_model import YuanVisionModel


# Note: This is under development and may be missing features.
class YuanVLChatModel(MegatronModule):
    """YuanVLChatModel multi-modal model.
    ...
    def __init__(
        ...
        # patch self_attention to use Yuan_vl attention
        vision_transformer_layer_spec.submodules.self_attention.module = YuanVLSelfAttention
        for layer_spec in language_transformer_layer_spec.layer_specs:
            layer_spec.submodules.self_attention.module = YuanVLSelfAttention

        logging.getLogger(__name__).warning("YuanVLChatModel model is under development and may be missing features.")
        ...
        if self.pre_process:
            self.vision_model = YuanVisionModel(
    ...
    def set_input_tensor(self, input_tensor) -> None:
        ...
        assert len(input_tensor) == 1, "input_tensor should only be length 1 for YuanVLChatModel"
    ...
    def forward(
        ...
        """Forward function of the YuanVLChatModel model.
