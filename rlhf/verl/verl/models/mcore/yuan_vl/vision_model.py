...
from .vision_transformer_block import YuanVisionTransformerBlock as TransformerBlock


# copied from https://github.com/huggingface/transformers/blob/main/src/transformers/models/internvl/modeling_internvl.py
...
class YuanVisionModel(VisionModule):
    """Yuan ViT vision model.
    ...
    def __init__(
        ...
        self.window_size = transformer_config._Yuan_vl_window_size
    ...
    def forward(
        ...
        """Forward function of the Yuan Vision Model. This function passes the input tensors
