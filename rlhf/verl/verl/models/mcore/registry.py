...
from .weight_converter import (
    ...
    McoreToHFWeightConverterYuan,
    McoreToHFWeightConverterYuanVL,
)
...
class SupportedModel(Enum):
    ...
    YUAN = "YuanForCausalLM"  # not tested
    YUANVL = "YuanVLChatModel"  # not tested
...
MODEL_CONFIG_CONVERTER_REGISTRY: dict[SupportedModel, Callable[[PretrainedConfig, torch.dtype], TransformerConfig]] = {
    ...
    SupportedModel.YUAN: hf_to_mcore_config_yuan,
    SupportedModel.YUANVL: hf_to_mcore_config_yuan_vl,
}
...
MODEL_INITIALIZER_REGISTRY: dict[SupportedModel, type[BaseModelInitializer]] = {
    ...
    SupportedModel.YUAN: YuanMoEModel,
    SupportedModel.YUANVL: YuanVLChatModel,
}
...
MODEL_FORWARD_REGISTRY: dict[SupportedModel, Callable] = {
    ...
    SupportedModel.DEEPSEEK_V3: gptmodel_forward,
    SupportedModel.YUAN: gptmodel_forward,
    SupportedModel.YUANVL: gptmodel_forward_yuanvl,
}
...
MODEL_FORWARD_FUSED_REGISTRY: dict[SupportedModel, Callable] = {
    ...
    SupportedModel.QWEN2_5_VL: fused_forward_qwen2_5_vl,
    SupportedModel.DEEPSEEK_V3: fused_forward_gptmodel,
    SupportedModel.YUAN: fused_forward_gptmodel,
    SupportedModel.YUANVL: fused_forward_yuan_vl,
}
...
MODEL_WEIGHT_CONVERTER_REGISTRY: dict[SupportedModel, type] = {
    ...
    SupportedModel.YUAN: McoreToHFWeightConverterYuan,
    SupportedModel.YUANVL: McoreToHFWeightConverterYuanVL,
}
