...
class Tracking:
    ...
    def __init__(self, project_name, experiment_name, default_backend: str | list[str] = "console", config=None):
        ...
        if "tensorboard" in default_backend:
            save_path_tensorboard = config['trainer']['default_local_dir']
            self.logger["tensorboard"] = _TensorboardAdapter(project_name, experiment_name, save_path_tensorboard)
...
class _TensorboardAdapter:
    def __init__(self, project_name, experiment_name, save_path_tensorboard):
        import os

        from torch.utils.tensorboard import SummaryWriter

        tensorboard_dir = os.environ.get("TENSORBOARD_DIR", f"{save_path_tensorboard}/tensorboard")#os.environ.get("TENSORBOARD_DIR", f"tensorboard_log/{project_name}/{experiment_name}")
