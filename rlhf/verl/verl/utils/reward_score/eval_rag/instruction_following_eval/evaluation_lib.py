...
from verl.utils.reward_score.eval_rag.instruction_following_eval import instructions_registry
...
def eval_instruction_following_strict(inp, response):
...
def print_report(outputs, file_name = None):
