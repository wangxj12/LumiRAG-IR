...
class EngineArgs:
    ...
    def _is_v1_supported_oracle(self, model_config: ModelConfig) -> bool:
        ...
        if self.pipeline_parallel_size > 1:
            supports_pp = hasattr(self.distributed_executor_backend, 'supports_pp') and self.distributed_executor_backend.supports_pp
            if not supports_pp and self.distributed_executor_backend \
