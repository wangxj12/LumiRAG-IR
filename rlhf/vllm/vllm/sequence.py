...
class SequenceData(msgspec.Struct,
    ...
    def get_mm_offset(self) -> int:
        return self._mm_offset
...
class Sequence:
    ...
    def __init__(
        ...
        if 'mm_placeholders' in self.inputs:
            for x in self.inputs['mm_placeholders']['image']:
                self.data._mm_offset += x.length
